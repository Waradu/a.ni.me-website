<template>
  <header
    class="w-full select-none h-12 lg:h-14 flex p-4 lg:p-5 items-center justify-between text-muted"
  >
    <div class="text-sm w-32">
      by
      <NuxtLink
        class="transition hover:text-theme underline"
        target="_blank"
        to="https://waradu.dev"
      >
        Waradu
...
import { SvglGitHubLogo } from "@selemondev/svgl-vue";
